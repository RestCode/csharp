/* This file is automatically generated by RestCode Parser Generator */

namespace RestCode.Generators.CSharp
{
	using System.Linq;
	using System;
	using RestCode.Core.Infrastructure;
...
//------------------------------------------------------------------------------
//<auto-generated>
//  This file is auto-generated by RestCode
//  Project site: http://github.com/faniereynders/RestCode
//  
...
__sb.Append(@".Models
{
	public class RestCodeResponseException : Exception
	{
		public HttpStatusCode StatusCode { get; private set; }
		public string Content { get; private set; }

		public RestCodeResponseException(HttpStatusCode statusCode, string content) : base(""A "" + statusCode + "" ("" + (int)statusCode + "") http exception occured. See Content for response body."")
		{
...
__sb.Append(@"BaseAddress)
		...
		{			
			...
			throw new RestCodeResponseException(response.StatusCode, content);			
		}
