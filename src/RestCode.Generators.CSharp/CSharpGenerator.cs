namespace RestCode.Generators.CSharp
{
    ...
    {
        public const string ConfigFileName = "RestCode.config";
        public const string CacheFile = "RestCode.generated.cache";

        private string _clientSuffix = "Client";
        private string _name = "MyRestCode";
